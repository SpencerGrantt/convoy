      ...
      <div className="max-w-5xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 max-w-4xl mx-auto">
          {Object.entries(PLAN_META).map(([key, meta]) => (
            <div key={key} className="bg-navy-700 rounded-2xl border border-white/[0.08] p-8">
              ...
              <button
                ...
                className="w-full mt-8 bg-brand-600 text-white font-bold px-8 py-3 rounded-xl transition-colors hover:bg-brand-700"
              >
                Request a Demo
              </button>
            </div>
